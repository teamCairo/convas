...
class EditInterest extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    ref.watch(editInterestProvider).categoryDocIdNameMap.forEach((key, value) {
      checkList.add(
        CheckboxListTile(
          ...
          value: ref.watch(editInterestProvider).categoryDocIdboolMap[key.toString()],
          onChanged: (bool? value) {
            ref.read(editInterestProvider.notifier).setBool(key.toString(),!(value!));
          },
    ...
    ref.watch(editInterestProvider).categoryDocIdboolMap.forEach((key, value) {
      if(value){
