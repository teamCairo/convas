...
class SetNameAndBirthdate extends ConsumerWidget {
  const SetNameAndBirthdate({
    Key? key,
  }) : super(key: key);
            ...
            children: <Widget>[
              Column(
                children: [
                  ...
                  commonText20BlackCenter("Let's set your name and birthdate"),
                ],
              ),
              Column(
                children: [
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: commonButtonOrangeRound(
                      text: "Set later",
                      onPressed: () {
                        ref.watch(registerProvider.notifier).setName("Anonimous");
                        ref.watch(registerProvider.notifier).setBirthDate(null);
                        Navigator.of(context).push(
                          PageRouteBuilder(
                            pageBuilder: (context, animation, secondaryAnimation) {
                              return const OptionGoalSetting();
